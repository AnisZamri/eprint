                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <img src="{{asset('frontend/assets/img/product/stickerbiasa.png')}}" alt="John" style="width:20%">
                                    ...
                                    <td class="cart__price">RM150.0</td>
                                    <td class="cart__quantity">
                                        <div class="pro-qty">
                                            <input type="text" value="1">
                                        </div>
                                    </td>
                                    <td class="cart__total">RM300.0</td>
                                </tr>
                                <tr>
                                    <td class="cart__product__item">
                                    <img src="{{asset('frontend/assets/img/product/stickerdiecut.png')}}" alt="Jane" style="width:20%">
                                        <div class="cart__product__item__title">
                                            <h6>Sticker Die Cut</h6>
                                            <div class="rating">
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
